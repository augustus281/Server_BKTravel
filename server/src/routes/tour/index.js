...
router.put("/:tour_id", formidableMiddleware(), asyncHandler(tourController.updateTour))
...
router.post("/:tour_id/upload", asyncHandler(tourController.updateCoverImageTour))
