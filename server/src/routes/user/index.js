...
router.get("/wishlist/:user_id", authenticate, asyncHandler(userController.getWishlistByCustomer))
router.post("/wishlist/:user_id/tours/:tour_id", authenticate, asyncHandler(userController.addTourToWishlist))
router.delete("/wishlist/:user_id/tours/:tour_id", authenticate, asyncHandler(userController.removeTourFromWishlist))
